<?php $__env->startSection('content'); ?>
    <div class="breadcrumbs container">
        <ul class="breadcrumbs__list">
            ...
            <li class="breadcrumbs__item">
                <span class="breadcrumbs__link"><?php echo e($product->title); ?></span>
            </li>
        </ul>
    </div>
    <div class="page-wrappered container">
        <div class="header-section">
            <h1 class="car-title"><?php echo e($product->title); ?></h1>
        ...
        <div class="content-section">
            <div class="image-and-pricing">
                    <div class="car-main-image">
                        <img src="<?php echo e($product->image_path); ?>" alt="<?php echo e($product->title); ?>">
                ...
                <div class="pricing-card">
                    <h2 class="car-model"><?php echo e($product->title); ?></h2>
                    <div class="car-image">
                        <img src="<?php echo e($product->image_path); ?>" alt="<?php echo e($product->title); ?>">
                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH L:\project\car_open_server\SexCars\resources\views/pages/product.blade.php ENDPATH**/ ?>