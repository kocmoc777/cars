...
@section('content')
    ...
    <header class="header">
        <div class="wrapper">
            <img class="header-image" src="{{asset('image/slider.png')}}" alt="">
    ...
    <div class="card-wrappered container">
        @foreach($categories as $category)
            <a href="{{route('catalog',$category->hash)}}" class="vehicle-card">
    ...
    <div class="about ">
        <div class="container">
            ...
            <div class="text-about-down">
                ...
                <div class="container">
                    <img class="container" src="{{asset('image/Toyota Corolla.png')}}" alt="">

                    <p><br><strong>Типові спортивні автомобілі, створені для задоволення від водіння</strong></p>

                    <img class="container" src="{{asset('image/Lamborghini Huracan.png')}}" alt="">

                    <p><br><strong> Екстремальні автомобілі, призначені для високопродуктивного водіння,
                            перегонів</strong>
                    </p>
                    <img class="container" src="{{asset('image/Aston Martin.png')}}" alt="dfgfs">
